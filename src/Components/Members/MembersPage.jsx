...
// -------------------------------------------
const ViewSelector = ({ viewMode, setViewMode, userRole, membersT }) => {
...
const MembersPageWrapper = ({ initialView }) => {
  ...
  const membersT = (ui[language] || ui.en).members;
    ...
    <MembersProvider>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-serif font-bold text-gray-900">{membersT.pageTitle}</h1>
          <ViewSelector viewMode={viewMode} setViewMode={setViewMode} userRole={user?.role} membersT={membersT} />
        </div>
